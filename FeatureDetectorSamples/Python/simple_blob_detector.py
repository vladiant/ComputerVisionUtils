...
while True:
    ...
    current_threshold_step = cv.getTrackbarPos('Threshold Step', 'SimpleBlobDetector') + 10
    current_min_blob_dist = cv.getTrackbarPos('Min Dist Between Blobs', 'SimpleBlobDetector')
    current_min_repeatability = cv.getTrackbarPos('Min Repeatability', 'SimpleBlobDetector') + 2
    ...
    current_min_circularity = cv.getTrackbarPos('Min Circularity', 'SimpleBlobDetector') / 10
    current_max_circularity = cv.getTrackbarPos('Max Circularity', 'SimpleBlobDetector') / 10
    ...
    current_min_convexity = cv.getTrackbarPos('Min Convexity', 'SimpleBlobDetector') / 10
    current_max_convexity = cv.getTrackbarPos('Max Convexity', 'SimpleBlobDetector') / 10
