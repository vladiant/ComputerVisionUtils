...
while True:
    ...
    current_norm_orientation = cv.getTrackbarPos('Normalize Orientation', 'FREAK BF Matcher')
    ...
    # Initiate FREAK
    descriptor = cv.xfeatures2d.FREAK_create(orientationNormalized=current_norm_orientation,
