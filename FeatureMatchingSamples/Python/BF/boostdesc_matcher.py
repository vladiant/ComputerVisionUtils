...
while True:
    ...
    current_scale_orientation = cv.getTrackbarPos('Scale Orientation', 'BoostDesc BF Matcher')
    ...
    current_scale_factor = cv.getTrackbarPos('Scale Factor', 'BoostDesc BF Matcher') * 0.25

    # Initiate BoostDesc
    descriptor = cv.xfeatures2d.BoostDesc_create(desc=matcher_types[current_type],
